...
def comment(request, pk):
    ...
    if form.is_valid():
        ...
        messages.add_message(request, messages.SUCCESS, '评论发送成功', extra_tags='success')
    ...
    messages.add_message(request, messages.ERROR, '评论发送失败，请修改好表单中错误重新发送', extra_tags='danger')
